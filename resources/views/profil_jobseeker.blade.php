    ...
    <body id="page-top py-5">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="{{ route('user.image', Auth::user()->id) }}" alt="..." /></span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#Minat">Minat</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#Pencapaian">Pencapaian</a></li>
                </ul>
            </div>
        </nav>
        <!-- Page Content-->
        <div class="container-fluid py-5">
            ...
            <hr class="m-0" />
            <!-- Minat-->
            <section class="resume-section" id="Minat">
                <div class="resume-section-content">
            ...
            <hr class="m-0" />
            <!-- Pencapaian-->
            <section class="resume-section" id="Pencapaian">
                <div class="resume-section-content">
                    <h2 class="mb-5">Pencapaian & Sertifikat</h2>
                    <ul class="fa-ul mb-0">
                        <li>
